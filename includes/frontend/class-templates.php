...
class Palladio_Frontend_Templates {
	...
	public function template_include( $template ) {
		...
		if ( is_singular( 'pll_edificio' ) ) {
			...
			$map = array( 'single-pll_territorio.php' );
			...
			$map = array( 'archive-pll_scenario.php' );
		}
	...
	public function body_class( $classes ) {
		if (
			is_singular( array( 'pll_edificio', 'pll_unita', 'pll_scenario', 'pll_storia', 'pll_territorio' ) )
			|| is_post_type_archive( array( 'pll_edificio', 'pll_unita', 'pll_scenario' ) )
		) {
			$classes[] = 'palladio';
